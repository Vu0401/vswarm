...
| **model_config**      | `bool`  | Configuration for the model, identical to [API Chat Completions body requests](https://platform.openai.com/docs/api-reference/chat/create).            | `{}`   
|
