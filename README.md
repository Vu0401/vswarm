...
| **model_config**      | `bool`  | Model configuration, identical to Chat Completions body requests. [API Reference](https://platform.openai.com/docs/api-reference/chat/create).         | `{}`   
|
